...
//                 {/* Panneau droit */}
//                 <div className="w-2/3 min-h-[calc(100vh-2rem)] bg-white rounded-t-3xl rounded-b-3xl shadow-md m-2 overflow-y-auto">
...
//             {/* Modal */}
//             <Modal ref={modalRef} onCreateStart={handleModalSubmit} />

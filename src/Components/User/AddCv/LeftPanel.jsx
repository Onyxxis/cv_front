...
//   return (
//     <div className="relative h-full w-full flex flex-col bg-slate-900 border-r border-slate-700/50 p-6 text-white overflow-hidden">
...
//       <div className="mb-8 p-4 bg-slate-800/50 rounded-xl border border-slate-700/50 backdrop-blur-sm">
//         <button
//           onClick={onChooseTemplate}
//           className="w-full group"
//         >
//           <div className="flex items-center justify-between p-3 rounded-lg bg-slate-700/30 hover:bg-slate-700/50 transition-all duration-300 border border-slate-600/50 hover:border-slate-500/50">
...
//           className="w-full bg-slate-800/50 hover:bg-slate-700/50 text-slate-300 hover:text-white font-medium py-3 px-4 rounded-xl border border-slate-700/50 hover:border-slate-600/50 transition-all duration-300"
//         >
//           Annuler
//         </button>
//       </div>

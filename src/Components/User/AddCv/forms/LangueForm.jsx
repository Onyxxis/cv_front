...
//     );
//     setLangues(newLangues);
//     onUpdateItem('langues', index, newLangues[index]);
//   };
...
//                 <div
//                   className={`h-2 rounded-full transition-all duration-500 ${langue.niveau === 'debutant' ? 'bg-red-500 w-1/5' :
//                       langue.niveau === 'intermediaire' ? 'bg-orange-500 w-2/5' :
//                         langue.niveau === 'courant' ? 'bg-yellow-500 w-3/5' :
//                           langue.niveau === 'avance' ? 'bg-green-500 w-4/5' :
//                             'bg-blue-500 w-full'
//                     }`}
//                 ></div>
//               </div>

  ...
  return (
    <section className="py-20 bg-white">
      ...
      <div className="flex flex-col py-22 sm:flex-row gap-4 justify-center items-center">
          <button className="bg-gradient-to-r from-blue-600 to-pink-800 text-white font-semibold text-base px-6 py-3 rounded-lg hover:from-blue-700 hover:to-pink-900 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl w-full sm:w-auto">

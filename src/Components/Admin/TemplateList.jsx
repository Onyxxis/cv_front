...
// import { FiPlus, FiEye, FiEdit2, FiTrash2, FiX, FiSearch } from "react-icons/fi";
...
//       <h1 className="text-3xl font-bold mb-6">Liste des Templates</h1>
...
//                 <img
//                   src={tpl.preview_image || "https://via.placeholder.com/150"}
//                   alt={tpl.name}
...
//         className="fixed bottom-6 right-6 bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-full shadow-lg flex items-center justify-center transition-colors"
//       >
//         <FiPlus size={24} />
//       </button>
...
//         >
//           <div
//             className="bg-white rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex animate-scale-in"
...
//               <p><strong>Premium:</strong> {viewingTemplate.is_premium ? "Oui" : "Non"}</p>
//               <p>
//                 <strong>Fichier:</strong>{" "}
//                 <a href={viewingTemplate.file_link} target="_blank" rel="noreferrer" className="text-blue-600 underline">
//                   Voir le fichier
//                 </a>
//               </p>
//             </div>

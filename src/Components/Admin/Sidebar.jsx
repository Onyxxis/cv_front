...
const Sidebar = ({ isCollapsed, setIsCollapsed }) => {
  ...
  return (
    <div
      className={`bg-gradient-to-b from-blue-900 to-blue-800 text-white transition-all duration-300 ease-in-out flex flex-col fixed h-screen ${isCollapsed ? "w-24" : "w-50"
        }`}
    >
      {/* Logo */}
      <div className="p-4 border-b border-white">
        <div
          className={`flex items-center ${isCollapsed ? "justify-center" : "space-x-4 mb-10"
            }`}
        >
          <img
